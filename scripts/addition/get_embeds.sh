python ./src/get_embeds.py \
    --data_path ./data/hard.jsonl \
    --output_path ./data/embeddings_hard/llama-2-7b \
...
python ./src/get_embeds.py \
    --data_path ./data/hard.jsonl \
    --output_path ./data/embeddings_hard/llama-2-13b \
...
python ./src/get_embeds.py \
    --data_path ./data/hard.jsonl \
    --output_path ./data/embeddings_hard/Mistral-7B \
